        ...
        <div className="lg:col-span-2 space-y-10">
          ...
          <div className="flex flex-wrap items-center gap-4">
            <button
              ...
              className="flex items-center gap-2 px-8 py-3.5 bg-red-600 hover:bg-red-700 text-white font-bold rounded-full transition-all duration-300 shadow-[0_0_20px_rgba(255,0,0,0.3)] hover:scale-105 active:scale-95"
            >

...
export default function MediaCard({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-20 flex flex-col items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200 bg-black/65 backdrop-blur-[2px] p-2">
        <Link
          href={watchHref}
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-1 py-1 bg-white/10 hover:bg-white/20 text-neutral-300 text-[10px] font-semibold rounded-md border border-white/10 transition-all active:scale-95"
        >
      ...
      <Link href={detailHref} className="absolute inset-x-0 bottom-0 p-3 z-10 block">
